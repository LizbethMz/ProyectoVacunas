...
-- Tablas independientes (sin dependencias de FK)
CREATE TABLE `ciudad` (
  `codigo` int(11) NOT NULL,
  `nombre` varchar(100) NOT NULL,
  PRIMARY KEY (`codigo`),
  UNIQUE KEY `UC_CIUDAD_NOMBRE` (`nombre`)
...
CREATE TABLE `farmaceutica` (
  ...
  PRIMARY KEY (`codigo`),
  UNIQUE KEY `UC_FARMACEUTICA_NOMBRE` (`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `laboratorio` (
  ...
  PRIMARY KEY (`codigo`),
  UNIQUE KEY `UC_LABORATORIO_NOMBRE` (`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `marca` (
  ...
  PRIMARY KEY (`codigo`),
  UNIQUE KEY `UC_MARCA_NOMBRE` (`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `modelo` (
  ...
  CONSTRAINT `modelo_ibfk_1` FOREIGN KEY (`cod_marca`) REFERENCES `marca` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `planta` (
  ...
  PRIMARY KEY (`numero`),
  UNIQUE KEY `UC_PLANTA_NOMBRE` (`nombre`),
  KEY `cod_laboratorio` (`cod_laboratorio`),
  KEY `cod_ciudad` (`cod_ciudad`),
  CONSTRAINT `planta_ibfk_1` FOREIGN KEY (`cod_laboratorio`) REFERENCES `laboratorio` (`codigo`),
  CONSTRAINT `planta_ibfk_2` FOREIGN KEY (`cod_ciudad`) REFERENCES `ciudad` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `sucursal` (
  ...
  `cod_ciudad` int(11) NOT NULL,
  PRIMARY KEY (`codigo`),
  UNIQUE KEY `UC_SUCURSAL_NOMBRE` (`nombre`),
  KEY `cod_farmaceutica` (`cod_farmaceutica`),
  KEY `cod_ciudad` (`cod_ciudad`),
  CONSTRAINT `sucursal_ibfk_1` FOREIGN KEY (`cod_farmaceutica`) REFERENCES `farmaceutica` (`codigo`),
  CONSTRAINT `sucursal_ibfk_2` FOREIGN KEY (`cod_ciudad`) REFERENCES `ciudad` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `camion` (
  ...
  KEY `cod_marca` (`cod_marca`),
  CONSTRAINT `camion_ibfk_1` FOREIGN KEY (`cod_modelo`) REFERENCES `modelo` (`codigo`),
  CONSTRAINT `camion_ibfk_2` FOREIGN KEY (`cod_marca`) REFERENCES `marca` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `envio` (
  ...
  CONSTRAINT `envio_ibfk_1` FOREIGN KEY (`cod_camion`) REFERENCES `camion` (`codigo`),
  CONSTRAINT `envio_ibfk_2` FOREIGN KEY (`cod_sucursal`) REFERENCES `sucursal` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `camion_conductor` (
  ...
  PRIMARY KEY (`cod_camion`,`num_conductor`),
  KEY `num_conductor` (`num_conductor`),
  CONSTRAINT `camion_conductor_ibfk_1` FOREIGN KEY (`cod_camion`) REFERENCES `camion` (`codigo`),
  CONSTRAINT `camion_conductor_ibfk_2` FOREIGN KEY (`num_conductor`) REFERENCES `conductor` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `estado` (
  ...
  CONSTRAINT `estado_ibfk_1` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `incidente` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `num_envio` (`num_envio`),
  CONSTRAINT `incidente_ibfk_1` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `paquete` (
  ...
  `num_envio` int(11) NOT NULL,
  PRIMARY KEY (`codigo`),
  KEY `num_planta` (`num_planta`),
  KEY `FK_paquete` (`num_envio`),
  CONSTRAINT `FK_paquete` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`),
  CONSTRAINT `paquete_ibfk_1` FOREIGN KEY (`num_planta`) REFERENCES `planta` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `registro_temperatura` (
  ...
  PRIMARY KEY (`numero`),
  KEY `num_envio` (`num_envio`),
  CONSTRAINT `registro_temperatura_ibfk_1` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ruta` (
  ...
  KEY `num_planta` (`num_planta`),
  KEY `cod_sucursal` (`cod_sucursal`),
  CONSTRAINT `ruta_ibfk_1` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`),
  CONSTRAINT `ruta_ibfk_2` FOREIGN KEY (`num_planta`) REFERENCES `planta` (`numero`),
  CONSTRAINT `ruta_ibfk_3` FOREIGN KEY (`cod_sucursal`) REFERENCES `sucursal` (`codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `envio_estado` (
  ...
  PRIMARY KEY (`id`),
  KEY `num_envio` (`num_envio`),
  KEY `num_estado` (`num_estado`),
  CONSTRAINT `envio_estado_ibfk_1` FOREIGN KEY (`num_envio`) REFERENCES `envio` (`numero`),
  CONSTRAINT `envio_estado_ibfk_2` FOREIGN KEY (`num_estado`) REFERENCES `estado` (`numero`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE usuarios (
    ...
    num_conductor INT,
    tipo_usuario VARCHAR(10) DEFAULT 'user' NOT NULL,
